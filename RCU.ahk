...
Run, cmd /c cd C:\Users\mjdeb\OneDrive\AutoHotKey\RemoteHK & Git status & git add RCU.ahk & Git status & git commit -m "automatic update from RCU.ahk" & git push & Pause
